...
class Config:
    ...
    data_dir: Path = Path('./Dhan-Shomadhan/preprocessed') 
    ...
    finetune_mode: str = 'linear_probe'  # 'full_ft' | 'linear_probe | partial_ft'
    drop_rate: float = 0.2
    img_size: int = 224
    ...
    val_ratio: float = 0.2  # Updated to 20% for validation
    test_ratio: float = 0.1  # Updated to 10% for testing
